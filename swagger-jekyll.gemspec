Gem::Specification.new do |s|
  ...
  s.files       = ['lib/swagger_jekyll.rb',
                   'lib/swagger_jekyll/path.rb',
                   'lib/swagger_jekyll/reference.rb',
                   'lib/swagger_jekyll/response.rb',
                   'lib/swagger_jekyll/schema.rb',
                   'lib/swagger_jekyll/specification.rb',
                   'lib/swagger_jekyll/verb.rb',
                   'lib/swagger_jekyll/schema/all_of.rb',
                   'lib/swagger_jekyll/schema/any_of.rb',
                   'lib/swagger_jekyll/schema/array.rb',
                   'lib/swagger_jekyll/schema/number.rb',
                   'lib/swagger_jekyll/schema/object.rb',
